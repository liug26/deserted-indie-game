...
"""
Chi enemy scene, acts like Gui but slower and can darkens player's
vision when close by. have a far chasing range. Node is only slightly
changed from Gui's node.
"""
...
export var chase_player_distance_squared = 60000
